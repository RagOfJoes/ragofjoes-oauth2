			...
			<Grid container justify="center" alignItems="center" direction="column" className={styles.container}>
				<Paper elevation={2} className={styles.paper}>
					<Grid item container spacing={2} direction="column" alignItems="center">
						...
						<Grid item style={{ width: '100%' }}>
							<form
								...
								<ButtonBase style={{ width: '100%', borderRadius: 4 }}>
									<Card elevation={2} className={styles.card} onClick={() => continueForm.current.submit()}>
										<Grid container spacing={2} wrap="nowrap" justify="space-between" alignItems="center">
											<Grid item>
												<Typography align="left" gutterBottom variant="subtitle2" color="textSecondary">
													Continue as
												</Typography>
												<Typography align="left" variant="body1" color="textPrimary">
													{full}{' '}
													<Typography align="left" variant="subtitle2" component="strong" color="primary">
														{email}
													</Typography>
												</Typography>
											</Grid>
						...
						<Grid item>
							<form ref={switchForm} method="POST" autoComplete="off" action={`/interaction/${uid}/continue`}>
