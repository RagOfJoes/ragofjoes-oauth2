...
import scopeDefinitions from 'lib/scopeDefinitions';
					...
					<Paper className={styles.paper}>
						...
						<Grid item container spacing={1} direction="column" alignItems="center">
							<Grid item style={{ width: '100%' }}>
								<form method="post" autoComplete="off" action={`/interaction/${uid}/confirm`}>
							...
							<Grid item>
								<form method="post" autoComplete="off" action={`/interaction/${uid}/abort`}>
